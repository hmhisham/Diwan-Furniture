...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category">برنامج إدارة معارض الاثاث</li>
            <li class="slide">
            ...
            @can('الموردين')
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}">
                        ...
                        </svg><span class="side-menu__label">الموردين</span><i class="angle fe fe-chevron-down"></i>
                    </a>
                    <ul class="slide-menu">
                        @can('قائمة الموردين')
            ...
            @can('الوجبات')
                <li class="side-item side-item-category">الوجبات</li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                            ...
                            <path
                                d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z" />
                        </svg><span class="side-menu__label">الوجبات</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">

                        @can('قائمة الوجبات')
                            <li><a class="slide-item" href="{{ Route('Containers.index') }}">قائمة الوجبات</a></li>
                        @endcan

                        @can('ادخال مواد الوجبة')
                            <li><a class="slide-item" href="{{ Route('Items.index') }}">ادخال مواد الوجبة</a></li>
                        @endcan
                    </ul>
                </li>
            @endcan
            ...
            @can('المخزن')
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                            ...
                            <path
                                d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z" />
                        </svg><span class="side-menu__label">المخزن</span><i class="angle fe fe-chevron-down"></i>
                    </a>
                    <ul class="slide-menu">
                        @can('كشف المخزن')
            ...
            @can('المصاريف')
                <li class="side-item side-item-category">المصاريف</li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                            ...
                            <path
                                d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z" />
                        </svg><span class="side-menu__label">المصاريف</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
            ...
            @can('الارباح')
                <li class="side-item side-item-category">الارباح</li>
                ...
                <li class="slide">
                    <a class="side-menu__item" href="#">
                        ...
                        <span class="side-menu__label">الارباح</span>
                    </a>
                </li>
            @endcan
            ...
            @can('المستخدمين')
                ...
                <li class="slide
                    {{ (request()->is('users/create')) ? 'is-expanded' : '' }}
                    {{ (request()->is('users/*/edit')) ? 'is-expanded' : '' }}
                    {{ (request()->is('roles/create')) ? 'is-expanded' : '' }}
                    ">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}">
                        <i class="fa fa-users side-menu__icon" style="margin-top:-15px; font-size:20px"></i>
                    ...
                    <ul class="slide-menu">
                        @can('قائمة المستخدمين')
                            ...
                            <li><a class="slide-item {{ (request()->is('users/create')) ? 'active' : 'hidden' }}" href="{{ url('/' . ($page = '#')) }}">إضافة مستخدم</a></li>
                            <li><a class="slide-item {{ (request()->is('users/*/edit')) ? 'active' : 'hidden' }}" href="{{ url('/' . ($page = '#')) }}">تحديث مستخدم</a></li>
                        @endcan
                        @role('owner|مدير')
                            @can('أدوار المستخدمين')
                                <li><a class="slide-item" href="{{ url('/' . ($page = 'roles')) }}">أدوار المستخدمين</a></li>
                                <li><a class="slide-item {{ (request()->is('roles/create')) ? 'active' : 'hidden' }}"" href="{{ url('/' . ($page = '#')) }}">إضافة دور</a></li>
                            @endcan
                            @can('صلاحيات المستخدمين')
                                <li><a class="slide-item" href="{{ Route('permission.index') }}">صلاحيات المستخدمين</a></li>
                            @endcan
                        @endrole
                    </ul>
                </li>
