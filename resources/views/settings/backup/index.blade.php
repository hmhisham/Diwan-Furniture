...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">النسخ الاحتياطي</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    قائمة النسخ الاحتياطية</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
...
@section('content')
    ...
    @if (session()->has('delete'))
        <script>
            window.onload = function() {
                notif({
                    msg: "تم حذف النسخة الاحتياطية بنجاح",
                    type: "success"
                });
            }
        </script>
            ...
            <div class="card mg-b-20">
                <div class="card-header mb-2 bg-primary text-white">
                    <div class="d-flex justify-content-between">
                        <div class="margin-tb">
                            <h4 class="content-title mb-0 my-auto">قائمة النسخ الاحتياطية</h4>
                        </div>
                        <div class="margin-tb">
                            @can('النسخ الاحتياطي')
                                <a class="btn btn-light rounded-50 btn-md" href="{{ Route('DatabaseBackup') }}">
                                    النسخ الاحتياطي
                                </a>
                            @endcan
                        </div>
